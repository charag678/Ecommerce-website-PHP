...
<section class="checkout">
    ...
    <input type="hidden" name="total_price" value="<?= $grand_total; ?>">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span>city :</span>
                <input type="text" maxlength="50" placeholder="e.g. jaipur" required class="box" name="city">
            </div>
            <div class="inputBox">
                <span>state :</span>
                <input type="text" maxlength="50" placeholder="e.g. rajasthan" required class="box" name="state">
            </div>
            <div class="inputBox">
                <span>country :</span>
